class ComplexNumber:
    ...
    def __truediv__(self, other):
        new_real = other.real_part / ((other.real_part ** 2) + (other.im_part ** 2))
        new_imaginary = -(other.im_part / ((other.real_part ** 2) + (other.im_part ** 2)))
        real = self.real_part * new_real - self.im_part * new_imaginary
        imaginary = self.real_part * new_imaginary + new_real * self.im_part
        return ComplexNumber(real, imaginary)
